...
const Footer=()=>{
    return(
        <div className="bg-gradient-to-br from-[#000325] from-20% via-[#060142] to-[#24022b] to-70%  h-76 ">
        <div className="h-68  flex justify-evenly py-8 text-white">
            ...
            <div className=" w-2/5 md:w-1/5 px-4 py-4">
                ...
                <div className="text-sm mt-4">
                    This is an AI - NFT Daap ,used to mint unique nfts that can be sold on various platforms at desired rates<br></br> For any help Contact us
                </div>
            </div>
        </div>
